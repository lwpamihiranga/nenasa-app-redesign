...
export function CreateExamScreen({ navigation }) {
	...
	const onChangeHour = (hourValue) => {
		setHour(hourValue);
	};
	const onChangeMins = (minValue) => {
		setMin(minValue);
	};
	const onChangeLevel = (levelValue) => {
		setLevel(levelValue);
	};
		...
		<View style={styles.container}>
			<View style={styles.topHalf}>
				...
				<View style={styles.hoursMins}>
					...
					<Picker
						selectedValue={min}
						onValueChange={onChangeMins}
						style={styles.minsPicker}>
				...
				<Picker
					...
					onValueChange={onChangeMedium}
					style={styles.mediumPicker}>
