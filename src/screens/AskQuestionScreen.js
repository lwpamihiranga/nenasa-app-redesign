	...
	return (
		...
		<View style={styles.container}>
           ...
           <TextInput 
            ...
            <TouchableOpacity
                style={{ flex: 1 ,maxHeight:100,marginTop:20,marginLeft: 20,marginRight:20}}
                >
                <View
                    style={{
                        flex: 1,
            ...
            <TouchableOpacity
                style={{ flex: 1 ,maxHeight:60,marginTop:20,marginLeft: 20,marginRight:20}}
                ...
                <View
                    ...
                    <Text style={{color:'#f0f8ff',fontSize:18}}>Submit</Text>
                </View>
            </TouchableOpacity>
